...
botao_fotos_videos = driver.find_element(By.XPATH, '//span[text()="Fotos e vídeos"]/../input') # input é tag irmã de span
botao_fotos_videos.send_keys("./dados/passaro.jpeg")
